...
public class Student extends Aplicant {
    ...
    public Student() {
        super();
		Student.sumaFinantare = 30;
    }

    public Student(String nume, String prenume, int varsta, int punctaj, int numarProiecte, String[] denumireProiect, String facultate, int anStudii, int sumaFinantare) {
