...
public class Angajat extends Aplicant{
    ...
    public Angajat(String nume, String prenume, int varsta, int punctaj, int numarProiecte, String[] denumiriProiecte, int salariu, String ocupatie, int sumaFinantare) {
